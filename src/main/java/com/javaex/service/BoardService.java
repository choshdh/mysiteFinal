...
public class BoardService {
	...
	public Map<String,Object> list(int sp, String kwd, String st) {
		...
		int movePage = (pageBundleSize/2)+1;//화살표 클릭시 몇페이지씩 옆으로 이동시킬 것인지 지정 이보다 크게 지정하면 페이징에 문제가 발생하게 될꺼임
		...
		//--1)사용자가 선택한 페이지값 유효성 검사 및 표시할 페이지의 정상 작동을 위한 페이지 이동 , 범위 지정
		...
		//DB 검색을 통한 값으로 생성될수 있는 페이지수로 최대 범위 지정
